...
<!-- ################################# DIRECTION PAD END ################################# -->
                  ...
                  <div class="grid-container-volume-channel-control" >
                      <input type="text" id="keypadinput" class="btn-flat flat-high ripple" style="margin-top: 0px; height: 50%;border: 2px solid white;" placeholder="Search..." @click="${() => this._remote_key_press("c")} @keydown="${() => this._remote_key_press("k")}>">
                  </div>
