...
<!-- ################################# DIRECTION PAD END ################################# -->
                  ...
                  <button class="btn ripple"  style="border-radius: 50% 50% 0px 0px; margin: 0px auto 0px auto; height: 100%;" @click=${() => this._volume_media_player_service("volume_up")}><ha-icon icon="mdi:plus"/></button>
                      ...
                      <paper-input class="btn-flat flat-low ripple" style="margin-top: 0px; height: 50%;border: 2px solid white;" placeholder="Search..." @keydown="${(event) => this._send_key(event)}"></paper-input>
